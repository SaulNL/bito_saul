...
export class AppSettings {
    ...
    public static RELEASE_DATE = "03 de octubre de 2022";
    public static VERSION_SISTEMA = 28;
    public static VERSION_ANDROID = 40; //ESTA SE TIENE QUE ACTUALIZAR
    ...
    public static VERSION_IOS = 7; //ESTA SE TIENE QUE ACTUALIZAR
