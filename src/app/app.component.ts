    ...
    constructor(
        ...
        this.router.events.subscribe((event) => {
            if (event instanceof NavigationEnd) {
                ...
                this.inicio = event.url == "/tabs/home?special=true" || event.url == "/tabs/home/conocenos" || event.url == "/tabs/home" || event.url == "/tabs/home/negocio" || event.url == "/tabs/home/solicitudes" || event.url == "/tabs/home/promociones" || event.url == "/tabs/mis-favoritos" ? true : false;
            }
        });
    }
