...
export class ModalPromocionComponent implements OnInit {
    ...
    constructor(public modalController: ModalController, private router: Router, private _promociones: PromocionesService, private _haversineService: HaversineService, private vioPromotionL: RegistrarPromotionService) {
        this.miLat = null;
        this.miLng = null;
    }
    ...
    private registrarVisitaAPromotion() {
        this.vioPromotionL.registrarQuienVio(this.promocion.id_promocion, this.idPersona, this.miLat, this.miLng);
    }
