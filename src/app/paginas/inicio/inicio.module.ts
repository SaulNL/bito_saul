...
import {BannerPromcionesComponent} from './../../componentes/banner-promciones/banner-promciones.component';
...
@NgModule({
  imports: [
    ...
    declarations: [InicioPage, ToolbarBusquedaComponent, BannerPromcionesComponent]
})
